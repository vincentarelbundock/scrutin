...
impl Action {
    ...
    pub(super) fn name(&self) -> &'static str {
        ...
        match self {
            ...
            EnterLog => "enter_log",
            OpenPalette(PaletteKind::Filter) => "filter_name",
            ...
            CycleStatusFilter => "filter_status",
            CycleStatusFilterBack => "filter_status_back",
            CycleToolFilter => "filter_tool",
            CycleToolFilterBack => "filter_tool_back",
            CycleGroupFilter => "filter_group",
            CycleGroupFilterBack => "filter_group_back",
    ...
    pub(super) fn from_name(s: &str) -> Option<Action> {
        ...
        Some(match s {
            ...
            "enter_log" => EnterLog,
            "filter_name" => OpenPalette(PaletteKind::Filter),
            ...
            "filter_status" => CycleStatusFilter,
            "filter_status_back" => CycleStatusFilterBack,
            "filter_tool" => CycleToolFilter,
            "filter_tool_back" => CycleToolFilterBack,
            "filter_group" => CycleGroupFilter,
            "filter_group_back" => CycleGroupFilterBack,
