...
impl Action {
    ...
    pub(super) fn name(&self) -> &'static str {
        ...
        match self {
            ...
            CycleToolFilter => "cycle_tool_filter",
            CycleToolFilterBack => "cycle_tool_filter_back",
    ...
    pub(super) fn from_name(s: &str) -> Option<Action> {
        ...
        Some(match s {
            ...
            "cycle_tool_filter" => CycleToolFilter,
            "cycle_tool_filter_back" => CycleToolFilterBack,
