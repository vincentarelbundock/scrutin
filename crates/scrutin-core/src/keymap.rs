...
pub static DEFAULT_KEYMAP: &[KeyBinding] = &[
    ...
    KeyBinding { key: "t",       action: "cycle_status_filter",     levels: FD, help: "t/T cycle status filter",  bar: "",                          when: When::Always },
    KeyBinding { key: "T",       action: "cycle_status_filter_back",levels: FD, help: "",                        bar: "",                          when: When::Always },
    KeyBinding { key: "p",       action: "cycle_suite_filter",     levels: FD, help: "p/P cycle suite filter",   bar: "",                          when: When::Always },
    KeyBinding { key: "P",       action: "cycle_suite_filter_back",levels: FD, help: "",                         bar: "",                          when: When::Always },
